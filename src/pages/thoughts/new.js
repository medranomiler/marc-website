  ...
  return (
    ...
    <h1 className="text-3xl">Create New Thought</h1>
        ...
        onSubmit={handleSubmit}>
            <input type="text" 
            className="block p-2.5 w-full text-sm text-slate-700 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 mb-2" placeholder="title"
            value={name}
            onChange={(e) => setName(e.target.value)}
            />
            <textarea id="message" rows="16" class="block p-2.5 w-full text-sm text-slate-700 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 mb-2" placeholder="Write your thoughts here..."
            value={content}
            ...
            <input type="date"
                   ...
                   className="block p-2.5 w-full text-sm text-slate-700 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
             </div>      
